...
public:
    ...
    explicit GuidedDecodingParams(GuideType guideType, std::optional<std::string> guide = std::nullopt, std::optional<std::int32_t> thinkingEndTokenId = std::nullopt);
    ...
    [[nodiscard]] std::optional<std::int32_t> getThinkingEndTokenId() const;
...
private:
    ...
    std::optional<std::int32_t> mThinkingEndTokenId;
};
