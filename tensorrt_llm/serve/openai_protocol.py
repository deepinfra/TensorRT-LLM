...
def _response_format_to_guided_decoding_params(
    ...
    if response_format is None:
        ...
        return GuidedDecodingParams(json=response_format.schema, thinking_end_token_id=response_format.thinking_end_token_id)
    elif response_format.type == "json_object":
        return GuidedDecodingParams(json_object=True, thinking_end_token_id=response_format.thinking_end_token_id)
