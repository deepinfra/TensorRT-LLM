...
def main(model_path: Optional[str], model: Optional[str], served_model_name: Optional[str],
         tokenizer: str, host: str, port: int, backend: str,
         ...
         trust_remote_code: bool, load_format: str, max_log_len: int,
         speculative_model: Optional[str], extra_llm_api_options: Optional[str]):
