...
class ModelConfig(Generic[TConfig]):
    ...
    def load_modelopt_quant_config(quant_config_file, checkpoint_dir,
        ...
        # Use name-based lookup to handle both cases.
        ...
        if moe_backend == 'TRTLLM' and quant_config.quant_algo == QuantAlgo.FP8_BLOCK_SCALES and quant_config.exclude_modules is None:
