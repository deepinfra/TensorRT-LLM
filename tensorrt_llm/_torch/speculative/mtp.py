...
from ..pyexecutor.sampler import (SampleState, SampleStateTensors, TorchSampler,
                                  Sampler, TorchStore, float_tensor, get_log_prob, greedy_search_sampling_batch, sampling_batch,
...
class MTPStore(TorchStore):
    ...
    def __init__(self, *, max_draft_len: int, max_num_sequences: int,
        ...
        self.log_probs = float_tensor((self.max_tokens, self.max_num_sequences, SINGLE_BEAM_WIDTH))
...
class MTPSampler(TorchSampler):
    ...
    def update_requests(
        ...
        for req in state.scheduled_requests.context_requests:
            ...
            log_prob = get_log_prob(req, log_probs, beam=BEAM_0)
